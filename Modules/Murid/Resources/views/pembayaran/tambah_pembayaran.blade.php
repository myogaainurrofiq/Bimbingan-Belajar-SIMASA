    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2>Pembayaran Untuk Bulan <span style="color: red">{{$getBln}}</span> </h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('pembayaran.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="date_file" class="form-control flatpickr-basic @error('date_file') is-invalid @enderror"  placeholder="Tanggal Transfer">
                                @error('date_file')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>
