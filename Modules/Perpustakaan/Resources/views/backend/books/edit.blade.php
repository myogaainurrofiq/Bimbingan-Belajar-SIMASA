                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('publication_year') is-invalid @enderror" value="{{$book->publication_year}}"  name="publication_year"/>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('isbn') is-invalid @enderror" value="{{$book->isbn}}" name="isbn"/>
                                        @error('isbn')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                            </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('stock') is-invalid @enderror" value="{{$book->stock}}" name="stock"/>
                                        @error('stock')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                            </div>
