                                            ...
                                            @foreach ($payment as $key => $payments)
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      @elseif(Date('m') == 11)
                                                        <span class="badge badge-{{$payments->payment->November == 'paid' ? 'info' : ($payments->payment->November == 'unpaid' ? 'warning' : 'alert')}}" style="display:{{$payments->payment->November == 'paid' ? 'hidden' : ''}} ">{{strtoupper($payments->payment->November)}}</span>
                                                      @elseif(Date('m') == 12)
